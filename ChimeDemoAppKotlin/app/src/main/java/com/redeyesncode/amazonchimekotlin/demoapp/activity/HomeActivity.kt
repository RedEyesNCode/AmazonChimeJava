...
import com.redeyesncode.amazonchimekotlin.demoapp.fragments.DebugSettingsFragment
import com.redeyesncode.amazonchimekotlin.model.DebugSettingsViewModel
import com.redeyesncode.amazonchimekotlin.utils.encodeURLParam
import com.redeyesncode.amazonchimekotlin.utils.showToast
...
class HomeActivity : AppCompatActivity() {
    ...
    private val MEETING_REGION = "ap-south-1"
    ...
    companion object {
        ...
        const val MEETING_ENDPOINT_KEY = "##"
...
//                showToast(getString(R.string.user_notification_meeting_url_error))
                ...
                val meetingResponseJson: String? = joinMeeting("##", meetingId, attendeeName, primaryMeetingId)
...
//        val meetingServerUrl = if (meetingUrl.endsWith("/")) meetingUrl else "$meetingUrl/"
        var url = "${meetingUrl}/join?title=${encodeURLParam(meetingId)}&name=${encodeURLParam(
